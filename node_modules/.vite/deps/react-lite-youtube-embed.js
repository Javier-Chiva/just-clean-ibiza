...
function LiteYouTubeEmbedComponent(props, ref) {
  ...
  var posterUrl = props.thumbnail || (!props.playlist ? "https://i.ytimg.com/".concat(vi, "/").concat(videoId, "/").concat(posterImp, ".").concat(format) : "https://i.ytimg.com/".concat(vi, "/").concat(videoPlaylistCoverId, "/").concat(posterImp, ".").concat(format));
